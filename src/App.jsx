...
export default function App() {
  ...
  const [newContent, setNewContent] = useState({ content_type: "blog", title: "", body: "", summary: "", tags: "" });
  ...
  const handleAddContent = async () => {
    ...
    try {
      ...
      showToast(t.toastAdded); setAddMode(false); setNewContent({ content_type: "blog", title: "", body: "", summary: "", tags: "" }); fetchContents();
        ...
        <div style={{ position: "fixed", inset: 0, zIndex: 100, display: "flex", justifyContent: "flex-end" }}>
          ...
          <div style={{ width: 540, maxWidth: "90vw", background: "#fff", overflowY: "auto", padding: "28px 32px", animation: "slideIn 0.3s ease" }}>
            ...
            <div style={{ marginBottom: 16 }}>
              ...
              <span style={{ fontSize: 12, padding: "3px 10px", borderRadius: 10, background: "#F1EFE8", color: "#5F5E5A", marginLeft: 8 }}>{TYPE_MAP[selected.content_type]?.label}</span>
            </div>
