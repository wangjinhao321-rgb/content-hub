        ...
        <nav style={{ width: 220, background: "#191654", color: "#fff", padding: "28px 0", display: "flex", flexDirection: "column", flexShrink: 0 }}>
          <div style={{ padding: "0 24px", marginBottom: 32 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
              <div style={{ width: 32, height: 32, borderRadius: 8, background: "#191654", display: "flex", alignItems: "center", justifyContent: "center" }}><svg width="22" height="22" viewBox="0 0 100 100" fill="none"><path d="M30 25C30 25 25 45 25 55C25 72 38 85 50 85C62 85 75 72 75 55C75 45 70 25 70 25C65 35 58 30 50 30C42 30 35 35 30 25Z" stroke="#fff" strokeWidth="5" strokeLinecap="round" fill="none"/><circle cx="38" cy="52" r="5" fill="#fff"/><circle cx="62" cy="52" r="5" fill="#fff"/><path d="M44 65C44 65 47 70 50 70C53 70 56 65 56 65" stroke="#fff" strokeWidth="4" strokeLinecap="round" fill="none"/></svg></div>
              <div>
